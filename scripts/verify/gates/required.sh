...
if [[ "$MODE" != "quick" ]]; then
    ...
    run_step shrike-r04-flash-contract python3 firmware/shrike/rp2040/host-tests/test_flash_contract.py
    ...
    # Shared control and host simulation tests run in core.sh for every mode.
