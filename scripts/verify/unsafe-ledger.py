...
CATALOG_PATH = ROOT / "docs/security/unsafe-ledger.toml"
LEDGER_PATH = ROOT / "docs/security/unsafe-ledger.md"
...
def render_markdown(sites: list[Site], obligations: tuple[Obligation, ...]) -> str:
    ...
    return f"""<!-- Generated by scripts/unsafe-ledger.py; edit unsafe-ledger.toml instead. -->
# Unsafe-code ledger
