...
- [~] Define consistent kernel, syscall, VM, BPF, and boot error policies.
  ...
  errors. Legacy VM/address-space string errors still prevent uniform closure.
