...
- [~] Publish per-crate line/branch coverage and add parser/verifier mutation
  ...
  required line/branch baselines cover 18 host-testable components, including
  ...
  `file_structure` plus standalone `rk_bridge` and `rk_cli`; versioned mutation
  ...
  Four `deferred-host` components still need measured coverage baselines.
