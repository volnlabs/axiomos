...
- [~] Publish per-crate line/branch coverage and add parser/verifier mutation
  ...
  `kernel_map_transaction`, `kernel_time`, and `kernel_usermem`, and versioned
  mutation floors cover the BPF verifier, ELF parser/loader, and full
  `shrike_link` protocol/state-machine crate. The remaining `deferred-host`
