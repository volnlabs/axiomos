...
- [~] Publish per-crate line/branch coverage and add parser/verifier mutation
  ...
  `region.rs` scope. Two `deferred-host` components still need measured
  coverage baselines.
