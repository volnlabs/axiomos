...
- [~] Publish per-crate line/branch coverage and add parser/verifier mutation
  ...
  `kernel_map_transaction`, and `kernel_usermem`, and versioned mutation floors
  cover the BPF verifier and ELF parser/loader. The remaining `deferred-host`
  components still need measured baselines.
