...
- [~] Publish per-crate line/branch coverage and add parser/verifier mutation
  ...
  mutation floors cover the BPF verifier and ELF parser/loader. The remaining
  `deferred-host` components still need measured baselines.
