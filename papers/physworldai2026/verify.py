...
assert "Transactional Controller Publication" in metadata, "Stale PDF title"
...
assert "Workshop:" in pages[0] and "Physical World AI" in pages[0]
assert "Extended abstract" in metadata and "CreationDate:" not in metadata
